...
namespace SimpleDbNET.UnitTests
{
    public class TransactionTest
    {
        ...
        {
            var fileManager = new FileManager("TransactionTest", 400, new TestBlocksReadWriteTracker(), TestLoggerFactory.Instance, true);
            ...
            Transaction tx1 = new Transaction(fileManager, logManager, bufferManager ,lockTable, TestLoggerFactory.Instance);
            ...
            Transaction tx2 = new Transaction(fileManager, logManager, bufferManager, lockTable, TestLoggerFactory.Instance);
            tx2.PinBlock(blk);
            ...
            Transaction tx3 = new Transaction(fileManager, logManager, bufferManager, lockTable, TestLoggerFactory.Instance);
            tx3.PinBlock(blk);
            ...
            Transaction tx4 = new Transaction(fileManager, logManager, bufferManager, lockTable, TestLoggerFactory.Instance);
            tx4.PinBlock(blk);
