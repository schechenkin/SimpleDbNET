...
namespace SimpleDB.Metadata
{
    public class IndexInfo
    {
         ...
         */
        public IndexInfo(DbString idxname, DbString fldname, Schema tblSchema, Transaction tx, StatInfo si)
        {
            this.idxname = idxname.GetString();
            this.fldname = fldname.GetString();
            this.tx = tx;
