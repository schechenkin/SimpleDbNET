...
{
    public class IndexJoinPlan : SimpleDb.Plan.Plan
    {
        private SimpleDb.Plan.Plan p1, p2;
         ...
         */
        public IndexJoinPlan(SimpleDb.Plan.Plan p1, SimpleDb.Plan.Plan p2, IndexInfo rightHandIndexInfo, String joinfield)
        {
            this.p1 = p1;
            this.p2 = p2;
